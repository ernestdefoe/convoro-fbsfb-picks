...
return [
    ...
    'follow_a_league' => 'Follow a league',
    'follow_a_league_note' => 'Pick a competition and a year. The fixtures arrive on the next sync, within the hour.',
    'follow' => 'Follow',
    'league' => 'League',
    'season_year' => 'Year',
    'season_following' => 'Now following {league} for {year}. Fixtures arrive on the next sync.',
    'season_league_unknown' => 'That is not a league this site knows about.',
    'season_year_unlikely' => 'That year looks wrong. Use a season between 2000 and two years from now.',
    'col_round' => 'Round',
    'col_dates' => 'Dates',
    'col_games' => 'Games',
    'col_players' => 'Players',
